...
    $('#input-box').val();
    //return newVal;  this breaks it here... the callback works
    
    }
    //useKvalueIdw(newVal);
...
var cancerGeojson = L.geoJson(cancerTract, {
    style: styleLayer,
...
//function useKvalue (newVal){
    ...
    let nitrCanFeature = turf.featureCollection(collectedIdwCanValues);
    ...
    //this slice for the chart.js test (works!!)

    let slice = xyPairs.slice(0,10);

    console.log("slice for chart test");console.log(slice); 
